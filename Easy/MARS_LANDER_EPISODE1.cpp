...
int main()
{
    ...
    while (1) {
        ...
        //comparison is done with respect to negative max value beasuse we are landing.
        if(vSpeed <= -40)
        {
            power = 4; // full thrist is given in order to compansate the gravity. and have smooth landing
        }
        else
        {
            power = 0; // moving smooth enough no thrust required.
        }
